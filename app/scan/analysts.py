...
ANALYSTS = [
    ("laowang", "AI甲", "技術派 / 趨勢", "均線交叉、量價、飆股與轉折點", _laowang),
    ("zhu", "AI乙", "經典 K 線派", "波段操作、形態學、結構化判讀", _zhu),
    ("you", "AI丙", "總體經濟 / 週期派", "景氣循環、大盤方向；偏好 ETF 與大型權值股", _you),
    ("guo", "AI丁", "基本面 / 財務派", "藍籌穩健、現金流；嚴格避開過熱與投機", _guo),
    ("gucan", "AI戊", "市場邏輯 / 反直覺", "反向操作、動態修正、超賣加碼超買警示", _gucan),
]
